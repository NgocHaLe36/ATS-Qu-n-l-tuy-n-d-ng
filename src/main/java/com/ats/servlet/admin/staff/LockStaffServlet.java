...
@WebServlet("/admin/staff/lock")
public class LockStaffServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        User currentAdmin = getCurrentAdmin(request, response);
        ...
        if (staff != null && "admin".equalsIgnoreCase(staff.getRole())
                && !currentAdmin.getId().equals(staff.getId())) {
