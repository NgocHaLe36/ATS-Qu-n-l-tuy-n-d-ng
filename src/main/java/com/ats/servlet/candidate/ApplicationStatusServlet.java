...
@WebServlet("/candidate/application-status")
public class ApplicationStatusServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        request.setAttribute("status", application.getStatus());
        ...
        request.getRequestDispatcher("/views/candidate/application-status.jsp").forward(request, response);
    }
