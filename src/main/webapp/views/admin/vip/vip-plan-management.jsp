...
<body>
    <aside class="admin-sidebar shadow-sm">
        ...
        <ul class="sidebar-menu">
            ...
            <li class="sidebar-item"><a href="vip-plan-management.jsp" class="sidebar-link active"><i class="bi bi-gem"></i> Quản lý gói VIP</a></li>
    ...
    <main class="admin-main">
        ...
        <div class="container-fluid p-4 flex-grow-1">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <div><h3 class="fw-bold mb-1">Quản lý Gói VIP (Plans)</h3><p class="text-muted small">Cấu hình thông tin bảng giá cho Nhà tuyển dụng</p></div>
                <button class="btn btn-primary rounded-pill px-4 fw-bold shadow-sm"><i class="bi bi-plus-lg me-2"></i>Tạo gói mới</button>
            </div>

            <div class="row g-4">
                <div class="col-md-4">
                    <div class="admin-card text-center position-relative border-primary border-opacity-25">
                        <h4 class="fw-bold mt-3">Gói Basic</h4>
                        <div class="plan-price my-3">500,000 đ</div>
                        <p class="text-muted small">Khởi đầu tốt nhất cho Doanh nghiệp nhỏ</p>
                        <ul class="list-unstyled text-start mt-4 mb-4">
                            <li class="mb-2"><i class="bi bi-check-circle-fill text-success me-2"></i><strong>Thời hạn:</strong> 30 ngày</li>
                            <li class="mb-2"><i class="bi bi-check-circle-fill text-success me-2"></i><strong>Giới hạn tin:</strong> 5 tin tuyển dụng</li>
                            <li class="mb-2"><i class="bi bi-check-circle-fill text-success me-2"></i>Mô tả: Sử dụng AI chấm CV cơ bản.</li>
                        </ul>
                        <button class="btn btn-outline-primary w-100 rounded-pill fw-bold">Chỉnh sửa</button>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="admin-card text-center position-relative shadow border-primary" style="transform: scale(1.05);">
                        <span class="position-absolute top-0 start-50 translate-middle badge rounded-pill bg-danger px-3 py-2">PHỔ BIẾN NHẤT</span>
                        <h4 class="fw-bold mt-3 text-primary">Gói Premium</h4>
                        <div class="plan-price my-3">2,500,000 đ</div>
                        <p class="text-muted small">Dành cho Doanh nghiệp tuyển dụng liên tục</p>
                        <ul class="list-unstyled text-start mt-4 mb-4">
                            <li class="mb-2"><i class="bi bi-check-circle-fill text-success me-2"></i><strong>Thời hạn:</strong> 90 ngày</li>
                            <li class="mb-2"><i class="bi bi-check-circle-fill text-success me-2"></i><strong>Giới hạn tin:</strong> 20 tin tuyển dụng</li>
                            <li class="mb-2"><i class="bi bi-check-circle-fill text-success me-2"></i>Mô tả: Ưu tiên hiển thị trang chủ.</li>
                        </ul>
                        <button class="btn btn-primary w-100 rounded-pill fw-bold shadow-sm">Chỉnh sửa</button>
                    </div>
                </div>
            </div>
        </div>
